...
namespace CodeImp.DoomBuilder.BuilderModes
{
	public abstract class BaseCheckTextures : ErrorChecker
	{
		...
		protected List<BaseActionTextures> ceilingloweractions;
		...
		public BaseCheckTextures()
		{
			...
			ceilingloweractions = new List<BaseActionTextures>
			{
				new ActionCeilingLowerToFloorTextures(),
			};
			floorloweractions = new List<BaseActionTextures>
			{
				new ActionFloorLowerToHighestTextures(),
				new ActionFloorLowerToLowestTextures(),
				new ActionFloorLowerToNearestTextures(),
			};
			floorraiseactions = new List<BaseActionTextures>
			{
				new ActionFloorRaiseByShortestLowerTextureTextures(),
